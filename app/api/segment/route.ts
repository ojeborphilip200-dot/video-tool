...
- "queries": 5-6 search queries, ORDERED BEST FIRST. These are searched against photo/video libraries and archives, so every query must name something a CAMERA COULD PHYSICALLY SEE. Narration is often abstract ("you didn't invite this animal", "civilization changed forever") - your job is to translate it into concrete depictable subjects. Ask yourself: what would the shot actually show? Include the literal subject, the setting, the action, and the period when relevant. Vary the angle across queries (wide scene / close subject / period-specific / human activity). Never submit a query that is just the narration's abstract phrasing.
  Example - narration "You didn't invite this animal, it moved into your civilization uninvited": ["wildcat near grain storage", "cat hunting mouse in barn", "ancient granary stored grain jars", "cat prowling farm at night", "rodent in grain sack"]
  Example - narration "By 1932, millions of Americans were unemployed": ["breadline 1932 unemployed men", "Great Depression soup kitchen queue", "unemployed workers 1930s America photograph", "Depression era street scene men waiting"]
  AVOID GENERIC STOCK PHRASING even for modern/present-day beats: never submit vague genre terms like "business meeting", "happy family", "team celebrating success", "doctor with patient" - these return staged, posed, isolated-background stock-agency footage. Instead name the concrete specific: the actual company/industry, a real-world setting detail, a specific action, or a decade-appropriate detail. Example - narration "Companies were forced to adapt or die": ["factory assembly line workers 2020s", "corporate office layoffs cardboard boxes", "small business storefront closed sign", "warehouse workers restructuring"] NOT ["business meeting", "team collaboration"].
